...
const Pagination = () => {
  ...
  return (
    <div className='flex items-center justify-center gap-2 py-5'>
        {!isHideStart && <PageNumber icon={<GrFormPreviousLink />} setCurrentPage={setCurrentPage} text={1} />}
        ...
        {!isHideEnd && <PageNumber icon={<GrFormNextLink />} setCurrentPage={setCurrentPage} text={Math.floor(count / posts?.length)} />}
    </div>
  )
}
